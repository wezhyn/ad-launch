...
public class SchedulerServerHeartListener implements RocketMQListener<ServerHeartMessage>, RocketMQPushConsumerLifecycleListener {
    ...
    public static final Integer MAX_EXPIRED_TIME = 30;
    ...
    public SchedulerServerHeartListener(GlobalIdentify globalIdentify,
        ...
        cache = CacheBuilder.newBuilder()
                ...
                .removalListener(new ServerHeartRemovalListener(resumeRecordService, equipTaskService))
                .build();
    }
...
//            收到其他服务器的心跳帧信息
    ...
    public static class ServerHeartRemovalListener implements RemovalListener<String, LocalDateTime> {
        ...
        public ServerHeartRemovalListener(ResumeRecordService resumeRecordService, EquipTaskService equipTaskService) {
...
//                转移当前故障机器的调度任务
                ...
                LocalResumeState.INSTANCE.resetResumeIndex(() -> lastRecord);
            }
        }
    }

...
import com.ad.admain.utils.Maps;
import com.ad.admain.utils.Strings;
...
public abstract class AbstractBaseMapAdapterModel<T> implements BaseModelI {
    ...
    private interface ReturnTypeConverter<S, T> {
    ...
    private static class MapAdapterCallbackInterceptor implements MethodInterceptor {
        ...
        private static final List<ReturnTypeConverter<?, ?>> typeConverters;
        ...
        public Object intercept(Object o, Method method, Object[] objects, MethodProxy methodProxy) throws Throwable {
            ...
            for (ReturnTypeConverter typeConverter : typeConverters) {
    ...
    private static class TradeStatusConverter implements ReturnTypeConverter<String, TradeStatus> {

        @Override
        public boolean canConvert(Class<?> targetType) {
            return TradeStatus.class.isAssignableFrom(targetType);
        }

        @Override
        public TradeStatus convert(String source, Class<TradeStatus> targetType) {
            return TradeStatus.valueOf(source);
        }
    }

    private static class BooleanConverter implements ReturnTypeConverter<String, Boolean> {
    ...
    private static class DoubleConverter implements ReturnTypeConverter<String, Double> {
    ...
    private static class LocalDateTimeConverter implements ReturnTypeConverter<String, LocalDateTime> {

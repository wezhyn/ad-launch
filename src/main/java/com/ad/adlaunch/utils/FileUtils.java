...
import com.ad.adlaunch.enumate.StringEnum;
...
/**
 * 默认保存地址 {@link com.ad.adlaunch.constants.ResourceConstant#RESOURCE_SAVE_LOCATION}
 *
 * @author : wezhyn
 * @date : 2019/09/20
 */
public class FileUtils {
    ...
    public static boolean saveToFile(Path path, InputStream inputStream) {
        boolean b=true;
     ...
     * @param relativeDirectory 相对于{@link com.ad.adlaunch.constants.ResourceConstant#RESOURCE_SAVE_LOCATION}
